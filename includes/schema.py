...
schema_unload_vars = T.StructType([
...
schema_impression = T.StructType([
    ...
    T.StructField("Engagement", T.IntegerType(),True),
    ...
    T.StructField("VisibilityPercentage", T.IntegerType(),True),
    ...
    T.StructField("RtbAdformIncludedFee", T.StringType(),True),
    T.StructField("RtbBrandSafetyCost", T.StringType(),True),
    T.StructField("RtbContextualTargetingCost", T.StringType(),True),
    T.StructField("RTBCrossDeviceCost", T.StringType(),True),
    T.StructField("RtbMediaCost", T.StringType(),True),
    T.StructField("RtbRichMediaFee", T.StringType(),True)
])

schema_from_meta = [T.StructType([
    T.StructField("id", T.LongType(),True),
